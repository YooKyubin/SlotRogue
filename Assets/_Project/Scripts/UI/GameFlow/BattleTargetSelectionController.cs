...
{
    internal sealed class BattleTargetSelectionController
    {
        ...
        internal BattleTargetSelectionController(
            BattleSystem battle,
        ...
        internal void Bind()
        {
            ...
            {
                Debug.LogWarning(
                    $"[BattleFlowController] Enemy count {_battle.Enemies.Count} exceeds configured slots {slotCount}.");
            }
        }
