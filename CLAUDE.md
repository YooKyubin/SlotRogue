...
- 문서 언어: **전부 한국어** (`CLAUDE.md`, `DOCS-STRUCTURE.md`, `docs/`, `references/` 모두).
- 코드 / 주석 / 식별자 / 파일명: **영어**.
...
4. **허브 문서 변경 시 sweep**: `CLAUDE.md`, `docs/INDEX.md`, `docs/GOVERNANCE.md` 등 다른 문서가 인용하는 허브 문서의 섹션 구조(번호·제목·이동)를 바꿀 땐, **같은 변경 안에서** inbound 참조를 grep으로 전수 검사하고 갱신.
