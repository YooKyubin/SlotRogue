...
| [`feature-attribute-artifacts.md`](./exec-plans/active/feature-attribute-artifacts.md) | _(슬롯 담당)_ | 2026-06-04 | 화염·빙결·독 속성 유물 + ArtifactDefinitionSO |
...
| [`feature-run-battle-mvvm.md`](./exec-plans/active/feature-run-battle-mvvm.md) | _(슬롯 담당)_ | 2026-06-05 | RunBattle CompositionRoot + 세분화 View + ViewModel 정리 |
