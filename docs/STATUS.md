...
**다인전 전투 확장** — [`feature-multi-participant-combat`](./exec-plans/completed/feature-multi-participant-combat.md) **완료** (2026-06-03): ADR-0004 Core roster·타겟·멀티히트·적 턴 규칙 + EditMode 테스트.
