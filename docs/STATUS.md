...
**RunBattle 적 슬롯 프리팹** — [`feature-enemy-formation-slot`](./exec-plans/active/feature-enemy-formation-slot.md): `EnemyFormationSlot` 프리팹, `MonsterDefinition.portrait`, hierarchy fallback 제거.
...
|------|-------|---------|----------------|
| [`feature-enemy-formation-slot.md`](./exec-plans/active/feature-enemy-formation-slot.md) | _(미정)_ | 2026-06-04 | RunBattle 적 슬롯 프리팹 + MonsterDefinition portrait |
