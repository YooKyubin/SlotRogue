...
**전투 연출 (Replay)** — [`feature-combat-presentation`](./exec-plans/active/feature-combat-presentation.md): ADR-0002 — `CombatEvent` 순차 재생, ViewModel, Dev_Battle 연출 MVP. **코드 미착수** (문서만 2026-05-31).

**슬롯 MVP** — [`feature-slot-core`](./exec-plans/active/feature-slot-core.md): `Dev_Slot`에서 5×3 검증. 다음: `Dev_Slot`↔전투 연동 follow-up.
...
|------|-------|---------|----------------|
| [`feature-combat-presentation.md`](./exec-plans/active/feature-combat-presentation.md) | _(전투·UI 담당)_ | 2026-05-31 | CombatEvent Replay 연출 + Dev_Battle 순차 await MVP |
