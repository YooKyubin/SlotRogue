...
| `EffectApplied` | Kind별 Presenter; **Before/After HP·Shield 스냅샷** (ADR-0002, 구현: [`feature-combat-presentation`](../exec-plans/active/feature-combat-presentation.md)) |
...
구현 plan: [`feature-combat-presentation`](../exec-plans/active/feature-combat-presentation.md).
...
- [`../exec-plans/active/feature-combat-presentation.md`](../exec-plans/active/feature-combat-presentation.md)
