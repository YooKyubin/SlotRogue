...
**Status**: draft  
**Last updated**: 2026-06-17 (ActionName 기반 적 행동 애니메이션)
...
| `ActionStarted` | 적 개별 행동 시작. `SourceParticipantId`와 `ActionName`으로 combat visual 행동 애니메이션 요청 |
...
| `ActionCompleted` | 적 개별 행동 완료. Intent 표시 상태 소비 |
